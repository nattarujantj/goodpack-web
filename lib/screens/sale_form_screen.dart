...
class _SaleFormScreenState extends State<SaleFormScreen> {
  ...
  Future<void> _initializeForm() async {
    ...
    if (widget.sale != null) {
      ...
      // ใส่ default notes สำหรับรายการขายใหม่
      _notesController.text = '''1).หลังโอนแล้ว จัดส่งภายใน1-3 วันทำการ
2).ยอดค่าระบุ30,000บาท จัดส่งในกรุงเทพ-ปริมณฑล
3).หากมีคำถึงความเสียหายประการใด กรุณาแจ้งกลับรีบเอาในวันที่รับสินค้าหากไม่มีแจ้งมาให้ทางร้านทราบถือว่าลูกค้าพึงพอใจ''';
    }
  }
